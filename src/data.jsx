// Project data — ported from VSDave11/project-yggdrasil.com
// Status map: Live → live · In Development → dev · Planned → plan · Concept → beta
const PROJECTS = [
  {
...
// Filler names for density tweak (above the real project count)
const FILLERS = [
  { code: "YGG-FLR-01", name: "Bifröst",   status: "plan" },
  { code: "YGG-FLR-02", name: "Ratatoskr", status: "plan" },
];
...
const TELEMETRY_SEED = [
  { l: "Active users",          v: "56",     u: "",     delta: "+12" },
  { l: "Branches in flight",    v: "6",      u: "",     delta: "+2" },
  { l: "Sub-projects in Kouzlo",v: "6",      u: "sports",delta: "+1" },
  { l: "Manual workflows killed",v: "284",    u: "wk",   delta: "+41%" },
];

const TIMELINE = [
  { when: "Feb 2026", t: "Seed",      d: "Drachir.gg and Kouzlo kickoff. Architecture for the schedule system and the automated confirm engine goes onto the whiteboard.", tag: "Origin" },
  { when: "Mar 2026", t: "Roots",     d: "Drachir.gg beta with the initial team. Prefill prototypes detect their first form fields. MCK requirements mapped end-to-end.", tag: "Foundation" },
  { when: "Apr 2026", t: "Trunk",     d: "Drachir.gg goes fully live — 56 active users. Automatic Prefill lights up. Kouzlo hits 50% with six sports in flight.", tag: "Today" },
  { when: "Next",     t: "Branching", d: "Schedule Script and GSheet Validation move from concept to R&D. Two more branches queued behind them.", tag: "Next" },
];

const TEAM = [
  { name: "David Kuchař",     role: "Drachir.gg · Schedule Script · GSheet Validation", initials: "DK" },
  { name: "Matyáš Perský",    role: "Manual CockpitKiller",                             initials: "MP" },
  { name: "Ladislav Bánský",  role: "Automatic Prefill",                                initials: "LB" },
  { name: "Stanislav Uhlík",  role: "Kouzlo · all six sports",                          initials: "SU" },
];

window.YGG_DATA = { PROJECTS, FILLERS, STATUS_LABEL, TELEMETRY_SEED, TIMELINE, TEAM };
